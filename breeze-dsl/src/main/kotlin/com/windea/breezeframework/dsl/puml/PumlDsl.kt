...
@PumlDsl
inline infix fun PumlNote.alias(alias: String) = this.also { it.alias = alias }

@PumlDsl
inline infix fun PumlNote.leftOf(targetId: String) = this.also { it.targetId = targetId }
	.also { it.position = PumlNotePosition.LeftOf }

@PumlDsl
inline infix fun PumlNote.rightOf(targetId: String) = this.also { it.targetId = targetId }
	.also { it.position = PumlNotePosition.RightOf }

@PumlDsl
inline infix fun PumlNote.topOf(targetId: String) = this.also { it.targetId = targetId }
	.also { it.position = PumlNotePosition.TopOf }

@PumlDsl
inline infix fun PumlNote.bottomOf(targetId: String) = this.also { it.targetId = targetId }
