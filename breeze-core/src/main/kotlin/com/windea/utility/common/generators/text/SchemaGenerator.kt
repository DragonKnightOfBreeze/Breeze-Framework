...
object SchemaGenerator : TextGenerator {
	 ...
	 * 输入文本的格式：扩展的Json Schema。
	 */
	fun generateExtendedSchema(inputText: String, inputType: DataType = DataType.Yaml, outputType: DataType = DataType.Yaml, options: ExtendedSchemaOptions.() -> Unit): String {
		ExtendedSchemaOptions().options()
	 ...
	 * 输入文本的格式：扩展的Json Schema。
	 */
	fun generateExtendedSchema(inputFile: File, outputFile: File, inputType: DataType = DataType.Yaml, outputType: DataType = DataType.Yaml, options: ExtendedSchemaOptions.() -> Unit) {
		ExtendedSchemaOptions().options()
