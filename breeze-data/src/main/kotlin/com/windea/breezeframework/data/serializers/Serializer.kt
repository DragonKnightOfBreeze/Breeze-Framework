...
//use typeOf<T>() here cause NotImplementedError (Java type is not yet supported for types created with ...)
//use user-defined javaTypeOf<T>() here instead, reference to jackson's TypeReference implementation.
