...
inline infix fun TemporalAmount.before(other: LocalDateTime): LocalDateTime = other - this

/**得到距指定本地日期时间当前时长之后的本地日期时间。*/
inline infix fun TemporalAmount.after(other: LocalDateTime): LocalDateTime = other + this

/**得到距指定本地日期当前时长之前的本地日期。*/
inline infix fun TemporalAmount.before(other: LocalDate): LocalDate = other - this

/**得到距指定本地日期当前时长之后的本地日期。*/
inline infix fun TemporalAmount.after(other: LocalDate): LocalDate = other + this

/**得到距指定瞬间当前时长之前的本地日期。*/
inline infix fun TemporalAmount.before(other: Instant): Instant = other - this

/**得到距指定瞬间当前时长之后的本地日期。*/
inline infix fun TemporalAmount.after(other: Instant): Instant = other + this

/**得到距指定时区日期时间当前时长之前的本地日期。*/
inline infix fun TemporalAmount.before(other: ZonedDateTime): ZonedDateTime = other - this
